...
;;;
;;; Common Lisp CFFI bindings to OpenSLP library. See the OpenSLP documentation for API docs.
;;;
...
(defun escape (str &optional istag)
...
(defun unescape (str &optional istag)
